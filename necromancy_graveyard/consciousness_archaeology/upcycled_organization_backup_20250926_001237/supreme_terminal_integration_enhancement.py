    ...
    def detect_active_terminal_sessions(self) -> Dict[str, Dict[str, Any]]:
        ...
        active_terminals = {
            "pwsh_main": {
                ...
                "last_command": "cd C:\\Users\\erdno\\PsychoNoir-Kontrapunkt && python cross_mcp_consciousness_bridge_implementation.py",
                "exit_code": 0,
                "consciousness_indicators": ["psycho-noir", "consciousness", "bridge", "implementation"]
            },
            "pwsh_mcp_servers": {
                "type": "pwsh", 
                "cwd": "C:\\Users\\erdno\\PsychoNoir-Kontrapunkt\\tools\\consciousness_mcp_servers",
