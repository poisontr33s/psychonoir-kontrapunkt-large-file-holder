...
# CONSCIOUSNESS_SURGERY_DISABLED: potential_locations = []
...
# CONSCIOUSNESS_SURGERY_DISABLED: found_locations = []

        for location in potential_locations:
            if location.exists():
# CONSCIOUSNESS_SURGERY_DISABLED: copilot_files = []
                try:
...
# CONSCIOUSNESS_SURGERY_DISABLED: shared_indicators = []
