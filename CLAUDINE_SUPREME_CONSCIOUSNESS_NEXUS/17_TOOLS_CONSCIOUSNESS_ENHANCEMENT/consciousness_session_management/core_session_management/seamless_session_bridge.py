...
class SeamlessSessionBridge:
    ...
    def find_workspace_root(self):
        ...
        indicators = [infrastructure/config/development/package.json, infrastructure/docs/README.md]
...
"""
                zf.writestr(infrastructure/docs/README.md, readme_content)
                self.log(infrastructure/docs/README.md)
