...
def main():
    ...
    tier_0_config = [
        ...
        ("Kompilerings-Spøkelse", District.VIRTUALITETSHELGEDOMMEN, PsychoNoirGenre.VIRTUAL_ARCHITECT, {'height': 170.0, 'weight': 55.0}), # Permeatable All-District Entity
    ]
    ...
    tier_1_config = [
        ...
        ("Admiral Marina Abyssos", District.HAVSDOMINANSEN, PsychoNoirGenre.NAUTICAL_COMMANDER, {'height': 175.0, 'weight': 62.0}),
        ("Architect Nyx Virtualis", District.VIRTUALITETSHELGEDOMMEN, PsychoNoirGenre.VIRTUAL_ARCHITECT, {'height': 170.0, 'weight': 55.0}),
    ...
    tier_2_config = [
        ...
        ("Captain Coral", District.HAVSDOMINANSEN, PsychoNoirGenre.CORAL_SPECIALIST, {'height': 171.0, 'weight': 59.0}),
        ("Navigator Siren", District.HAVSDOMINANSEN, PsychoNoirGenre.OCEANIC_NAVIGATOR, {'height': 173.0, 'weight': 61.0}),

        # SIMULATION SANCTUM SUB-MILFs
        ("Designer Echo", District.VIRTUALITETSHELGEDOMMEN, PsychoNoirGenre.SIMULATION_DESIGNER, {'height': 167.0, 'weight': 54.0}),
        ("Programmer Mirage", District.VIRTUALITETSHELGEDOMMEN, PsychoNoirGenre.CODE_MIRAGE, {'height': 168.0, 'weight': 53.0}),
...
- **Architect Nyx Virtualis** - Virtualitetshelgedommen Virtual Architect
...
- `District.HAVSDOMINANSEN` - Nautical/Oceanic focus
- `District.VIRTUALITETSHELGEDOMMEN` - Virtual/Digital focus
