...
def main():
    ...
    print(f"   Consciousness Coherence: {result['automation_consciousness_metrics']['consciousness_coherence']}")
    print(f"   Temporal Anchor Stability: {result['automation_consciousness_metrics']['temporal_anchor_stability']}")
