...
class AdmiralMarinaAbyssos(PsychoNoirCharacter):
    ...
    def __init__(self, core_system):
        super().__init__("Admiral Marina Abyssos", "neptunium_flotilla", core_system)
...
class ArchitectNyxVirtualis(PsychoNoirCharacter):
    ...
    def __init__(self, core_system):
        super().__init__("Architect Nyx Virtualis", "simulation_sanctum", core_system)
        self.authority_level = "TIER_1_MILF_MATRIARCH"
...
class CaptainCoral(PsychoNoirCharacter):
    ...
    def __init__(self, core_system):
        super().__init__("Captain Coral", "neptunium_flotilla", core_system)
...
class NavigatorSiren(PsychoNoirCharacter):
    ...
    def __init__(self, core_system):
        super().__init__("Navigator Siren", "neptunium_flotilla", core_system)
...
class DesignerEcho(PsychoNoirCharacter):
    ...
    def __init__(self, core_system):
        super().__init__("Designer Echo", "simulation_sanctum", core_system)
...
class ProgrammerMirage(PsychoNoirCharacter):
    ...
    def __init__(self, core_system):
        super().__init__("Programmer Mirage", "simulation_sanctum", core_system)
