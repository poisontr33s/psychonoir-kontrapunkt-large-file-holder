...
class ChatLogDiagnostics:
    ...
    def create_chat_log_bridge(self) -> Dict[str, Any]:
        ...
        manifest_path = bridge_dir / infrastructure/src/utilities/chat_bridge_manifest.json
...
"""
        ...
        export_script_path = bridge_dir / infrastructure/scripts/utilities/export_session.sh
...
"""
        ...
        import_script_path = bridge_dir / infrastructure/scripts/utilities/import_sessions.sh
