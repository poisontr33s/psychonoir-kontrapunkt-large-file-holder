...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--prefix=/ucrt64' '--build=x86_64-w64-mingw32' '--host=x86_64-w64-mingw32' '--target=x86_64-w64-mingw32' '--without-ext=readline,pty,syslog' 'extra_warnflags=-Wno-shorten-64-to-32 -Wno-dll-attribute-on-redeclaration' 'build_alias=x86_64-w64-mingw32' 'host_alias=x86_64-w64-mingw32' 'target_alias=x86_64-w64-mingw32' 'CC=gcc' 'CXX=g++' 'CFLAGS=-O3 -fstack-protector-strong' 'LDFLAGS=-pipe -s -fstack-protector-strong -lpthread' 'CPPFLAGS=' 'CXXFLAGS=-Wno-dll-attribute-on-redeclaration'"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-pipe -s -fstack-protector-strong -lpthread -Wl,--enable-auto-image-base,--enable-auto-import"
  CONFIG["ALLOCA"] = ""
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  CONFIG["cleanlibs"] = ""
  ...
  CONFIG["GCC"] = "yes"
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-Wno-dll-attribute-on-redeclaration"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-D_WIN32_WINNT=0x0600 -D__MINGW_USE_VC2005_COMPAT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -pipe -s -fstack-protector-strong -lpthread -Wl,--no-as-needed"
  CONFIG["CFLAGS"] = "-O3 -fstack-protector-strong"
