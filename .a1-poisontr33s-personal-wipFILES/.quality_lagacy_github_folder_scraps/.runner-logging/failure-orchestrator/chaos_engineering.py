...
class ChaosOrchestrator:
    ...
    def _initialize_chaos_scenarios(self) -> List[ChaosScenario]:
        ...
        return [
            ChaosScenario(
                ...
                mitigation_hints=["Verify infrastructure/config/development/package.json integrity", "Clear cache"]
            ),
            ChaosScenario(
                name="Memory Ghost",
    ...
    def _manifest_dependency_chaos(self, scenario: ChaosScenario) -> List[str]:
        ...
        # Simulate corrupted infrastructure/config/development/package.json
