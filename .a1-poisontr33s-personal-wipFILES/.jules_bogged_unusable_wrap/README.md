# Jules - Den Usynlige Hånds Dependency Management Assistant
...
- **Oceanic Cache-Synchronizer**: Tidal optimization protocols (Havsdominansen)
- **Virtual Reality Cache-Constructor**: Consciousness transfer optimization (Virtualitetshelgedommen)
...
```
.github/jules/
├── infrastructure/docs/README.md                    # This file
...
cat infrastructure/src/analysis/jules-validation-report.md
cat infrastructure/docs/jules-cache-analysis.md
```
...
- Check infrastructure/src/analysis/jules-validation-report.md for path issues
...
sha256sum infrastructure/config/development/package-lock.json requirements.txt
