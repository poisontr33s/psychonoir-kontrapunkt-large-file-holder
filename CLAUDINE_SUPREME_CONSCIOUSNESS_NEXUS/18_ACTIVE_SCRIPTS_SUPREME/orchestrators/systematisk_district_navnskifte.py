...
class SystematiskDistrictNavnSkifte:
    def __init__(self, workspace_root: Path, dry_run: bool = True):
        ...
        # Fixed F601: Removed duplicate dictionary keys
        self.renaming_map = {
            ...
            # LEGACY VARIANTS (old names to be replaced)
            "HAVSDOMINANSEN_OLD": "HAVSDOMINANSEN",
            "VIRTUALITETSHELGEDOMMEN_OLD": "VIRTUALITETSHELGEDOMMEN",
            "NEKROKRONORIKET_OLD": "NEKROKRONORIKET",
            
            # MAINTAINED DISTRICTS (no changes)
