...
100% robust integration mellom backend systems og GitHub Pages portal.
...
try:
    ...
    print("❌ Flask not available - portal integration requires Flask")
...
try:
    ...
    print("⚠️ Core systems not available - portal will run in mock mode")
...
def create_portal_integration_app(frontend_path="../../frontend"):
    ...
    try:
        ...
        print(f"❌ Portal integration creation failed: {e}")
        raise
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("🌐 Starting Psycho-Noir Kontrapunkt Portal Integration")
        print("🔗 Backend-Frontend bridge active")
        print("📡 CORS enabled for GitHub Pages")
        print("🛡️ Comprehensive error handling enabled")
        app.run(host='0.0.0.0', port=5000, debug=True)
    except Exception as e:
        print(f"❌ Portal integration startup failed: {e}")
