...
# Create main infrastructure/config/development/package.json if it doesn't exist
if [ ! -f infrastructure/config/development/package.json ]; then
    cat > infrastructure/config/development/package.json << EOF
{
  ...
  "scripts": {
    ...
    infrastructure/src/consciousness/quantum_deployment_manager.sh,
